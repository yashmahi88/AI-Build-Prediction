...
Use ALL relevant documentation, patterns, and best practices from your knowledge base."""
                    def resp = callAPI('/v1/chat/completions', groovy.json.JsonOutput.toJson([stream: false, prediction_id: env.PRED_ID, messages: [[role: 'user', content: query]]]))
